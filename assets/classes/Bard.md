...
**_Make a Scene:_** **Spend 3 Hope** to distract a target you can see. Until the end of the scene or until they suffer harm, all characters gain +1 on rolls against that target.
...
**_Rally:_** Once per session, describe how you rally the party. You and each ally gain +2 momentum (up to your max). Any character who is at max momentum instead takes +1 on their next roll.
