...
**_No Mercy:_** **Spend 3 Hope** to gain +1 on all Strike, Clash, Gain Ground, and Take Decisive Action rolls until the scene ends.
...
**_Attack of Opportunity:_** When you Gain Ground at close quarters by pursuing or cutting off a foe, improve your result by one level (miss → weak hit, weak hit → strong hit).
...
**_Combat Training:_** You are a master of weapons and combat. When you score a strong hit on a combat move, add +1 on your next combat move.
