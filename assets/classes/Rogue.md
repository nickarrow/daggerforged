...
**_Rogue's Dodge:_** **Spend 3 Hope** to gain +2 on all rolls to avoid or resist attacks until you roll a miss or the scene ends.
...
**_Cloaked:_** When you have successfully hidden yourself, you remain unseen even if an enemy moves to where they would normally see you, as long as you stay stationary. You lose this concealment when you attack or move within line of sight of an adversary.
...
**_Sneak Attack:_** When you Enter the Fray or Gain Ground using +Shadow and score a hit, you may immediately follow up with a deadly strike. On a strong hit, mark progress twice and take +1 momentum. On a weak hit, mark progress once.
