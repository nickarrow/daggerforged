...
**_Not This Time:_** **Spend 3 Hope** when you or an ally rolls a miss on a combat move. Reroll the challenge dice.
...
**_Prestidigitation:_** You can perform harmless, subtle magical effects at will — changing an object's color, creating a smell, lighting a candle, causing a tiny object to float, illuminating a room, or repairing a small object. This is a narrative permission requiring no roll.
...
**_Strange Patterns:_** Choose a number between 1 and 6. When your action die shows that number, gain +1 Hope or +1 Spirit (your choice). You can change this number when you Sojourn.
