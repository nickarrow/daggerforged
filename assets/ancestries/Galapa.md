...
**_Shell:_** Gain a bonus to your damage thresholds equal to your Proficiency.

**_Retract:_** **Mark a Stress** to retract into your shell. While in your shell, you have resistance to physical damage, you have disadvantage on action rolls, and you can't move.

---

### DAGGERFORGED ANCESTRY FEATURES

**_Shell:_** Your shell acts as natural armor. When you suffer physical harm, reduce it by 1 (minimum 0).

**_Retract:_** **Suffer -1 Spirit** to retract into your shell. While in your shell, you reduce all physical harm by half (round up), you have -2 on action rolls, and you can't move.
