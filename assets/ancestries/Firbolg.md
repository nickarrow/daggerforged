...
**_Charge:_** When you succeed on an Agility Roll to move from Far or Very Far range into Melee range with one or more targets, you can **mark a Stress** to deal **1d12** physical damage to all targets within Melee range.

**_Unshakable:_** When you would mark a Stress, roll a **d6.** On a result of 6, don't mark it.

---

### DAGGERFORGED ANCESTRY FEATURES

**_Charge:_** When you Enter the Fray or Gain Ground by rushing into close quarters, add +1 and mark progress on a hit.

**_Unshakable:_** When you would suffer -Spirit, roll a d6. On a result of 6, don't suffer it.
