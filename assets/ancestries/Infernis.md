...
**_Fearless:_** When you roll with Fear, you can **mark 2 Stress** to change it into a roll with Hope instead.

**_Dread Visage:_** You have advantage on rolls to intimidate hostile creatures.

---

### DAGGERFORGED ANCESTRY FEATURES

**_Fearless:_** When your action die shows 1-3, you can **suffer -2 Spirit** to treat it as though it showed 4+ instead.

**_Dread Visage:_** Add +2 when you Compel or otherwise intimidate through fear.
