...
**_Surefooted:_** You ignore disadvantage on Agility Rolls.

**_Danger Sense:_** Once per rest, **mark a Stress** to force an adversary to reroll an attack against you or an ally within Very Close range.

---

### DAGGERFORGED ANCESTRY FEATURES

**_Surefooted:_** Add +2 on any roll involving difficult terrain, balance, or footing.

**_Danger Sense:_** Once per scene, when you or an ally within close range reacts to an attack, you can **suffer -1 Spirit** to reroll the challenge dice.
