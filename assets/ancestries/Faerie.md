...
**_Luckbender:_** Once per session, after you or a willing ally within Close range makes an action roll, you can **spend 3 Hope** to reroll the Duality Dice.

**_Wings:_** You can fly. While flying, you can **mark a Stress** after an adversary makes an attack against you to gain a +2 bonus to your Evasion against that attack.

---

### DAGGERFORGED ANCESTRY FEATURES

**_Luckbender:_** Once per session, after you or a willing ally within close range makes an action roll, you can **spend 3 Hope** to reroll the challenge dice.

**_Wings:_** You can fly. While flying, you can **suffer -1 Spirit** when you react to an attack to reroll the challenge dice.
