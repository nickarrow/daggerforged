...
**_Sturdy:_** When you have 1 Hit Point remaining, attacks against you have disadvantage.

**_Tusks:_** When you succeed on an attack against a target within Melee range, you can **spend a Hope** to gore the target with your tusks, dealing an extra **1d6** damage.

---

### DAGGERFORGED ANCESTRY FEATURES

**_Sturdy:_** When you have only 1 Health remaining, add +2 to all combat moves (Enter the Fray, Strike, Clash, React Under Fire, Gain Ground, Take Decisive Action, Battle).

**_Tusks:_** When you score a hit on an attack against a target in close quarters, you can **spend 1 Hope** to gore the target with your tusks and mark +1 progress.
