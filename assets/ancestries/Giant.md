...
**_Endurance:_** Gain an additional Hit Point slot at character creation.

**_Reach:_** Treat any weapon, ability, spell, or other feature that has a Melee range as though it has a Very Close range instead.

---

### DAGGERFORGED ANCESTRY FEATURES

**_Endurance:_** Gain +1 to your maximum Health at character creation.

**_Reach:_** Your elongated arms grant you extended reach. You can strike or interact with targets just out of arm's reach as though they were in close quarters.
